---
title: "Técnicas creativas con fauna salvaje"
date: "2027-02-20"
summary: "Taller práctico de fotografía de naturaleza con técnicas creativas para observar, componer y capturar fauna salvaje desde una mirada artística y original."
sharingLinks:
featureImage: "taller_mario_cea_1.webp"
heroStyle: "big"
showHero: true
showAuthor: false
...
{{< gallery >}}
  <img src="taller_mario_cea_hero.webp" class="grid-w50 md:grid-w33 xl:grid-w25" />
  <img src="taller_mario_cea_1.webp" class="grid-w50 md:grid-w33 xl:grid-w25" />
  <img src="taller_mario_cea_2.webp" class="grid-w50 md:grid-w33 xl:grid-w25" />
  <img src="taller_mario_cea_3.webp" class="grid-w50 md:grid-w33 xl:grid-w25" />
  <img src="taller_mario_cea_4.webp" class="grid-w50 md:grid-w33 xl:grid-w25" />
  <img src="taller_mario_cea_5.webp" class="grid-w50 md:grid-w33 xl:grid-w25" />
{{< /gallery >}}
